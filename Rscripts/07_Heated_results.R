...
#Laptop
setwd("D:/Program Files (x86)/Google Drive/University of Toronto/Graduate/Methods/Aster Modelling/Aster Thesis 2019")

pdf(file = "Routput/heated_results01.pdf")
library(aster)
R.version.string

load("Routput/heated_mcmcprep03.RData")
...
save.image("Routput/heated_results01.RData")
