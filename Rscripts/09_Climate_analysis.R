...
temp_fig
ggsave(plot = temp_fig, filename = "Routput/Figures/fig_2a.png", width = 12, height = 9.5, units ="cm")
...
precip_fig <- climate %>%
  ...
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        ...
        legend.spacing.y = unit(0.0001, "mm"))
precip_fig
ggsave(plot = precip_fig, filename = "Routput/Figures/fig_2b.png", width = 12, height = 9.5, units = "cm")
