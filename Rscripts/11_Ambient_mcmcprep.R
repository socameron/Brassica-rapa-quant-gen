...
load("Routput/ambient_priors.RData")
...
mout <- metrop(lupfun, state.start, nspac = 2e4, nbatch = 1000, scale = 0.0018, outfun = is.parm)
mout$accept

#Started at 2pm Eastern Sat
save.image("Routput/ambient_mcmcprep02.RData")

#For the new 03 run
load("Routput/ambient_mcmcprep02.RData")

mout <- metrop(mout, nspac = 2e4, blen = 1, nbatch = 1000, scale = 0.0018)
mout$accept

#Started at around 9:30pm Monday 2020-03-16
save.image("Routput/ambient_mcmcprep03.RData")
